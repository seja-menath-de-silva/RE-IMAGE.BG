    ...
    <section className="py-8 sm:py-12 md:py-16 rounded-3xl mx-auto my-6 bg-[#F6F6F6] md:my-12 lg:my-20 xl:my-28 max-w-[1170px]" id='GetStarted'>
      <div className="container mx-auto px-4">
        <h2 className="text-2xl sm:text-3xl md:text-4xl text-center text-gray-900 mb-4 md:mb-6 font-extrabold">
          Ready to <span className="text-violet-400">remove</span> the<br />{' '}
          <span className="text-violet-400">background</span> of your image?
        </h2>
        ...
        <div className="flex justify-center">
          <button
            className="bg-violet-400 hover:bg-violet-300 text-white font-bold py-3 px-6 md:px-8 rounded-lg focus:outline-none focus:shadow-outline"
