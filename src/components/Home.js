...
export default function Home() {
  ...
  const handleChanges = () => {
    ...
    const apiKey = "c2cJ1uEB54wZMCBwhydsArEr";
    ...
    <main className="flex min-h-screen flex-col items-center justify-between p-4 md:p-24 max-sm:m-12" id="home">
      <div className="gap-8 items-center py-12 px-4 mx-auto max-w-screen-xl xl:gap-16 md:grid md:grid-cols-2 sm:py-16 lg:px-8">
        ...
        <div className="mt-4 md:mt-0">
          <div className="">
            <motion.h1 initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="text-4xl md:text-5xl font-extrabold text-violet-400">Remove the <br />background from <br />images for free.</motion.h1>
            ...
            <div className='mt-12'>
              <label htmlFor="image-upload" className="px-6 py-2 bg-violet-400 hover:bg-violet-300 text-white rounded-md cursor-pointer">
                Choose File
                <input
                  type="file"
                  id="image-upload"
