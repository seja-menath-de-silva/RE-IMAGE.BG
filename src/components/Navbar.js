      ...
      <div className="max-w-7xl mx-auto px-8 sm:px-6 py-3">
        <div className="">
          <div className="flex items-center justify-between h-16">
            ...
            >
              <span className='text-violet-400 hover:text-violet-300'>RE</span>IMGE
            </Link>
            ...
            <ul className="flex items-center ">
              <li>
                <Link
                  to="#howToUse"
                  className="mr-4 text-[16px] cursor-pointer hover:text-violet-300"
                  spy={true} smooth={true} offset={50} duration={500}
                >
                  How to Use
                </Link>
              ...
              <li>
                <Link
                  to="#GetStarted"
                  className="mr-4 text-[16px] hover:text-violet-300"
                  spy={true} smooth={true} offset={50} duration={500}
                >
                  Get Started
                </Link>
